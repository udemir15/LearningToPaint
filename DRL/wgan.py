...
class Discriminator(nn.Module):
        def __init__(self):
            ...
            self.cnn0 = weightNorm(nn.Conv2d(6, 16, 5, 2, 2))
            self.cnn1 = weightNorm(nn.Conv2d(16, 32, 5, 2, 2))
            self.cnn2 = weightNorm(nn.Conv2d(32, 64, 5, 2, 2))
            self.cnn3 = weightNorm(nn.Conv2d(64, 128, 5, 2, 2))
            self.cnn4 = weightNorm(nn.Conv2d(128, 1, 5, 2, 2))
            self.relu0 = TReLU()
            self.relu1 = TReLU()
            self.relu2 = TReLU()
            self.relu3 = TReLU()
